...
public class jdbcpostgreSQL {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            // CHANGE ME PER DATE.
            int[] orderIdArray = new int[] { 220904000, 220905000, 220906000, 220907000, 220908000, 220909000,
                    220910000,
            ...
            for (int i = 0; i < orderIdArray.length - 7; i++) {
                ...
                for (int j = 0; j < reorder.length; j++) {
                    ...
                    if (reorder[j] == orderId) { // if the day where reorder comes
                        ...
                        PreparedStatement amountReorder = conn
                                .prepareStatement("SELECT amount FROM inventory WHERE itemid=(?)");
...
>>>>>>> parent of b64d860 (Merge pull request #5 from CSCE315-F22-Taele/GUI)
